...
public class Main {
    public static void main(String[] args) {
        ...
        Invoice invoice1 = new Invoice("123", "45826", "Korea",
                "87737892378", "7521", "USD", 1585445.0, new Date());
        
        Invoice invoice2 = new Invoice("1234", "528456", "Seol",
                "38479839283", "5864", "USD", 1484858.0, new Date());
